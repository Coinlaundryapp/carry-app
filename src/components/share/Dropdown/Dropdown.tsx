    ...
    <SelectPrimitive.Root value={value} onValueChange={onChange} disabled={disabled}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          className="relative z-50 max-h-64 min-w-[8rem] overflow-hidden rounded-[10px] border bg-white font-medium text-label-neutral shadow-emphasize font-body-2-reading data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[side=bottom]:translate-y-3 data-[side=left]:-translate-x-3 data-[side=right]:translate-x-3 data-[side=top]:-translate-y-3"
          position="popper"
        >
