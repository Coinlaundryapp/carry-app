...
export default function MyPage() {
  return (
    <>
      <section className="bg-background-normal-alternative flex flex-col gap-6 px-5 py-6">
        <UserInfo />
        <div className="bg-static-white shadow-drop flex items-center justify-between rounded-md p-5">
          <div className="flex flex-col">
            <h2 className="text-label-normal font-headline-2 mb-1 font-semibold">
              캐리가 처음이신가요?
            </h2>
            <Link href="#" className="text-primary-normal font-label-1-normal flex font-semibold">
              이용 가이드 보러가기
              <ChevronRightPrimaryIcon />
            </Link>
          </div>
