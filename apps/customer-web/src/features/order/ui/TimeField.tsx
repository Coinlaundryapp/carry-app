  ...
  return (
    <>
      <section className="p-5">
        <h2 className="text-label-strong font-headline-1 font-semibold">수거/배달 일정</h2>
        <div className="mt-6">
          <p className="text-label-strong font-body-1-normal font-semibold">희망 수거 시간</p>
          <p className="text-label-assistive font-label-1-normal mt-2 font-semibold">
        ...
        <div className="mt-5">
          <p className="text-label-strong font-body-1-normal font-semibold">희망 배송 완료 시간</p>
          <p className="text-label-assistive font-label-1-normal mt-2 font-semibold">
          ...
          <Dropdown
            ...
            className="mt-3"
          />
          <div className="text-label-assistive font-caption-1 mt-2 font-medium">
            <ul className="font-caption-1 list-inside list-disc font-medium">
              <li>
                현재 세탁 수거 서비스는 <b className="text-primary-normal font-semibold">주말</b>만
                이용가능합니다
              </li>
              <li>
                일요일의 경우 신청 시간 마감시{' '}
                <b className="text-primary-normal font-semibold">차주 가장 빠른 주말 시간대</b>로
                안내해 드립니다
              </li>
            </ul>
          </div>
