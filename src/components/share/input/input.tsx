  ...
  "flex w-full px-4 py-2 gap-3 rounded-md items-center text-label-alternative",
  {
    variants: {
      status: {
        ...
        error:
          "border border-status-destructive bg-background-normal-alternative",
        success:
          "border border-status-positive bg-background-normal-alternative",
...
export function Input({
  ...
  return (
    <div className={cn("group space-y-2 w-full", className)}>
      {title && (
        <label
      ...
      >
        ...
        <input
          ...
          className="placeholder:text-label-assistive focus:outline-none font-body-2-normal caret-primary-normal bg-transparent text-label-normal w-full peer"
          {...props}
        />
