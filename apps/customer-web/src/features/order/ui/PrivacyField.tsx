    ...
    <section className="py-5">
      ...
      >
        <div className="flex w-full items-start justify-between">
          <label className="text-label-neutral font-label-1-reading font-semibold">
      ...
      >
        <div className="flex w-full items-start justify-between">
          <label className="text-label-alternative font-label-1-reading font-medium">
            (필수) 개인정보 수집 / 이용 동의
          </label>
          <Link
            href="#"
            className="text-label-alternative font-label-1-normal font-normal underline"
          >
            보기
          </Link>
        </div>
