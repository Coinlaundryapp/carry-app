    ...
    <>
      ...
      <div className="flex items-start py-[20px]">
        <div className="flex w-full flex-col gap-[16px] px-[20px]">
          <span className="font_headline_1 text-primary-normal font-semibold">신청 완료</span>
      ...
      <div className="bg-background-elevated-alternative h-[8px]" />
      {/* 주문 상세 정보 */}
      <div className="flex flex-col gap-[20px] p-[20px]">
        ...
        <div className="bg-line-normal h-[1px] w-full" />
        <div className="flex flex-col gap-[8px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font_body_2_normal text-label-normal font-semibold">4kg</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="font_body_2_normal text-label-alternative">사용 세탁기</span>
            <span className="font_body_2_normal text-label-normal font-semibold">18kg</span>
          </div>
        </div>
      </div>
      <div className="bg-background-elevated-alternative h-[8px]" />
      ...
      <div className="flex flex-col gap-[16px] p-[20px]">
        ...
        <div className="flex flex-col gap-[10px]">
          <div className="flex items-center justify-between">
            ...
            <span className="font_body_2_normal text-label-normal font-semibold">
              12월30일 (토) 낮 12시
            </span>
          </div>
          <div className="flex items-center justify-between">
      ...
      <div className="flex flex-col gap-[16px] p-[20px]">
        ...
        <div className="flex flex-col gap-[8px]">
          <span className="font_body_1_reading text-label-strong font-semibold">배송지 주소</span>
          <div className="flex flex-col gap-[8px]">
            <div className="flex gap-[8px]">
              <span className="font_body_1_normal text-label-neutral font-semibold">홍길동</span>
              <span></span>
        ...
        <div className="bg-line-neutral h-[1px] w-full" />
        <div className="flex flex-col gap-[12px]">
          <span className="font_body_1_reading text-label-strong font-semibold">배송 요청사항</span>
          <div className="flex flex-col gap-[8px]">
            <div className="flex gap-[12px]">
              <span className="font_label_1_normal text-primary-normal font-semibold">
                공동현관 비밀번호
              </span>
              <span className="font_label_1_normal text-label-neutral">종 1234 열쇠</span>
            </div>
            <div className="flex gap-[12px]">
              <span className="font_label_1_normal text-primary-normal font-semibold">???님께</span>
      ...
      <div className="flex flex-col gap-[24px] p-[20px]">
        ...
        <div className="flex flex-col gap-[20px]">
          <div className="flex flex-col gap-[12px]">
            <div className="flex flex-col gap-[8px]">
              <div className="font_body_1_reading text-label-normal flex justify-between self-stretch font-semibold">
                <span>세탁 금액</span>
                <span>10,500원</span>
              </div>
              <div className="font_label_1_normal text-label-alternative flex justify-between self-stretch">
                <span>ㄴ 할인금액</span>
                <span>0원</span>
              </div>
              <div className="font_label_1_normal text-label-alternative flex justify-between self-stretch">
          ...
          <div className="flex justify-between">
            <span className="font_headline_1 text-label-strong font-semibold">예상 결제 금액</span>
            <span className="font_heading_2 text-primary-normal font-semibold">14,550원~</span>
          </div>
        </div>
      </div>
