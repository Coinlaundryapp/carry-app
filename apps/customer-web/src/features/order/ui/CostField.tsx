  ...
  return (
    <>
      <section className="p-5">
        <h2 className="text-label-strong font-headline-1 font-semibold">결제 금액</h2>
        <div className="mt-6 flex flex-col">
          <div className="text-label-normal font-body-1-reading flex items-center justify-between font-semibold">
