  ...
  return (
    <div className="flex flex-col pb-6">
      <div className="mb-10 ml-2">
        <h2 className="text-label-strong font-heading-2 mb-2.5 font-semibold">
          몇 켤레 세탁을 원하시나요?
        </h2>
      </div>
      <div className="bg-background-normal-alternative mb-8 rounded-md py-6">
        <div className="flex flex-col items-center px-[15px]">
          <h3 className="font-body-1-norma text-label-strong mb-5 font-semibold">
          ...
          <div className="flex w-full flex-col">
            <p className="text-label-normal font-body-2-normal mb-3 font-semibold">
              이런 운동화는 추천하지 않아요
            </p>
            <div className="space-y-2">
              <div className="flex items-center gap-1">
                <WarnWaterWashIcon />
                <p className="text-label-neutral font-label-2 font-semibold">
      ...
      <div className="mb-[35px] px-4">
        <div className="mb-5 flex justify-between">
          ...
          <span className="text-label-alternative font-title-1 font-bold">
        ...
        <div className="text-label-alternative font-body-2-reading flex justify-between font-semibold">
          <span>1</span>
          <span>2</span>
          <span>3</span>
          <span>4</span>
